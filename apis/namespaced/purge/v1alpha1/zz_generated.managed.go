...
func (mg *AuditLog) GetProviderConfigReference() *xpv2.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this AuditLog.
func (mg *AuditLog) GetWriteConnectionSecretToReference() *xpv2.LocalSecretReference {
...
func (mg *AuditLog) SetProviderConfigReference(r *xpv2.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this AuditLog.
func (mg *AuditLog) SetWriteConnectionSecretToReference(r *xpv2.LocalSecretReference) {
